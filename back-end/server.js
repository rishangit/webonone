...
const systemServiceRoutes = require('./routes/systemServices');
...
const companyWebHeaderRoutes = require('./routes/companyWebHeaders');
const companyWebFooterRoutes = require('./routes/companyWebFooters');
const companyWebMediaRoutes = require('./routes/companyWebMedia');
const companyCustomFormRoutes = require('./routes/companyCustomForms');
const companyCustomFormSubmissionRoutes = require('./routes/companyCustomFormSubmissions');
...
app.use('/api/system-services', systemServiceRoutes);
app.use('/api/companies', companyRoutes);
app.use('/api/products', productRoutes);
app.use('/api/product-variants', require('./routes/productVariants'));
app.use('/api/system-product-attributes', require('./routes/systemProductAttributes'));
app.use('/api/product-related-attributes', require('./routes/productRelatedAttributes'));
app.use('/api/product-related-attribute-values', require('./routes/productRelatedAttributeValues'));
app.use('/api/units-of-measure', require('./routes/unitsOfMeasure'));
...
app.use('/api/company-web-headers', companyWebHeaderRoutes);
app.use('/api/company-web-footers', companyWebFooterRoutes);
app.use('/api/company-web-media', companyWebMediaRoutes);
app.use('/api/company-custom-forms', companyCustomFormRoutes);
app.use('/api/company-custom-form-submissions', companyCustomFormSubmissionRoutes);
