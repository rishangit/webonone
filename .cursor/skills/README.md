...
| [component-showcase](component-showcase/SKILL.md) | Adding or changing a reusable card/list component |
| [webpage-editor-addon](webpage-editor-addon/SKILL.md) | Adding a new WebpageEditor content addon |
