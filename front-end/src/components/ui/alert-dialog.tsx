...
>(({ className, ...props }, ref) => {
  ...
  const { "aria-describedby": ariaDescribedBy, children, ...restProps } = props;
  const describedBy = (ariaDescribedBy && ariaDescribedBy !== undefined && ariaDescribedBy !== "undefined") 
    ? ariaDescribedBy 
    : `alert-dialog-description-${dialogId || Math.random().toString(36).substring(2)}`;
  ...
  return (
    <AlertDialogPortal>
      ...
      >
        ...
        <AlertDialogPrimitive.Description id={describedBy} className="sr-only">
