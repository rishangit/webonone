        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={isReactHookFormMode ? undefined : getFieldValue('color')}
              onChange={(e) => {
                if (!isReactHookFormMode) {
              ...
              disabled={shouldDisableFields}
              readOnly={readOnly}
              className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground placeholder:text-muted-foreground ${readOnly ? 'cursor-default' : ''} ${errors?.color ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={isReactHookFormMode ? undefined : getFieldValue('size')}
                onChange={(e) => {
                  if (!isReactHookFormMode) {
                ...
                disabled={shouldDisableFields}
                readOnly={readOnly}
                className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground placeholder:text-muted-foreground ${readOnly ? 'cursor-default' : ''} ${errors?.size ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
              />
              {errors?.size && !readOnly && (
                <p className="text-sm text-red-500 mt-1 flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" />
                  {errors.size.message}
                </p>
            ...
            <div className="space-y-2">
              <Label htmlFor="sizeUnit" className="text-foreground">Size Unit</Label>
              {isReactHookFormMode && control ? (
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      onValueChange={(value: 'ml' | 'L') => field.onChange(value)}
                      disabled={shouldDisableFields}
                    >
                      <SelectTrigger 
                        id="sizeUnit"
                        disabled={shouldDisableFields}
                        className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground ${!shouldDisableFields ? 'hover:bg-[var(--accent-bg)] hover:border-[var(--accent-border)]' : 'cursor-default'} ${errors?.sizeUnit ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                      >
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <Select
                  value={getFieldValue('sizeUnit') || 'ml'}
                  onValueChange={(value: 'ml' | 'L') => handleFieldChange('sizeUnit', value)}
                  disabled={shouldDisableFields}
                >
                  <SelectTrigger 
                    id="sizeUnit"
                    disabled={shouldDisableFields}
                    className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground ${!shouldDisableFields ? 'hover:bg-[var(--accent-bg)] hover:border-[var(--accent-border)]' : 'cursor-default'}`}
                  >
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={isReactHookFormMode ? undefined : getFieldValue('weight')}
                onChange={(e) => {
                  if (!isReactHookFormMode) {
                ...
                disabled={shouldDisableFields}
                readOnly={readOnly}
                className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground placeholder:text-muted-foreground ${readOnly ? 'cursor-default' : ''} ${errors?.weight ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
              />
              {errors?.weight && !readOnly && (
                <p className="text-sm text-red-500 mt-1 flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" />
            ...
            <div className="space-y-2">
              <Label htmlFor="weightUnit" className="text-foreground">Weight Unit</Label>
              {isReactHookFormMode && control ? (
                <Controller
                  name="weightUnit"
                  control={control}
                  render={({ field }) => (
                    <Select
                      value={field.value || 'g'}
                      onValueChange={(value: 'mg' | 'g' | 'kg') => field.onChange(value)}
                      disabled={shouldDisableFields}
                    >
                      <SelectTrigger 
                        id="weightUnit"
                        disabled={shouldDisableFields}
                        className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground ${!shouldDisableFields ? 'hover:bg-[var(--accent-bg)] hover:border-[var(--accent-border)]' : 'cursor-default'} ${errors?.weightUnit ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                      >
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <Select
                  value={getFieldValue('weightUnit') || 'g'}
                  onValueChange={(value: 'mg' | 'g' | 'kg') => handleFieldChange('weightUnit', value)}
                  disabled={shouldDisableFields}
                >
                  <SelectTrigger 
                    id="weightUnit"
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Input
              ...
              value={isReactHookFormMode ? undefined : getFieldValue('material')}
              onChange={(e) => {
                if (!isReactHookFormMode) {
              ...
              disabled={shouldDisableFields}
              readOnly={readOnly}
              className={`bg-[var(--input-background)] border-[var(--glass-border)] text-foreground placeholder:text-muted-foreground ${readOnly ? 'cursor-default' : ''} ${errors?.material ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
            />
            {errors?.material && !readOnly && (
              <p className="text-sm text-red-500 mt-1 flex items-center gap-1">
                <AlertCircle className="w-3 h-3" />
