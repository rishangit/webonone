...
import { companyWebFootersService, type CompanyWebFooter } from "@/features/website/services/companyWebFooters";
    ...
    return (
      <div className="flex-1 p-4 lg:p-6 flex flex-col min-h-0">
        ...
        <EmptyState
          ...
          description="Choose a company from the header bar to manage site footers."
        />
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 p-4 lg:p-6 flex flex-col min-h-0">
      ...
      {loading ? (
        ...
        <EmptyState
          icon={LayoutTemplate}
          title="No footers yet"
          description="Add one to show a site-wide footer bar on your public site."
          action={{
            label: "Add footer",
