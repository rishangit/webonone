...
import { productRelatedAttributesService } from "@/features/products/services/productRelatedAttributes";
...
export const ProductAttributesDisplay = ({
  ...
  // Fetch attribute values for selected variant
  useEffect(() => {
    const fetchAttributeValues = async () => {
      ...
      try {
        const values = await productRelatedAttributeValuesService.getValuesByVariantId(selectedVariant.id);
