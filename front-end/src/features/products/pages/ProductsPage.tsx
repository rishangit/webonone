...
import { fetchCompanyProductsRequest, deleteCompanyProductRequest } from "@/features/products/store/companyProductsSlice";
      ...
      <div className="flex flex-col flex-1 min-h-[calc(100vh-300px)]">
        ...
        <div className="flex-1">
          {viewMode === "list" ? (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-3">
                        <div className="min-w-0 flex-1 mr-2">
                          ...
                          <div className="h-4 w-64 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-1" />
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="h-4 w-12 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-1" />
                      ...
                      <div className="h-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse mb-3" />
                      <div className="flex items-center justify-between">
            ...
            /* Skeleton for Grid View - Matching CompanyProductCard structure */
