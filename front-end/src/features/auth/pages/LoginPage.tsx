...
export function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (pendingUser && pendingRoles && pendingRoles.length > 0) {
      ...
      console.log(
        "[LoginPage] Available roles:",
        pendingRoles.map((r: any) => ({ id: r.id, role: r.roleName, companyId: r.companyId })),
      );
      ...
      <div className="w-full max-w-md relative z-10">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <Link to="/system/forgot-password">Forgot password?</Link>
                </Button>
              </div>
        ...
        <div className="text-center mt-8 md:mt-10 space-y-2">
          <p className="text-muted-foreground text-sm">
            ...
            >
              <Link to="/system/signup">Sign up</Link>
            </Button>
          </p>
