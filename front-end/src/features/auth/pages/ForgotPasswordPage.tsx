      ...
      <div className="w-full max-w-md relative z-10">
            ...
            {!emailSent ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* Submit Button */}
                  <Button type="submit" variant="accent" className="w-full font-medium mb-4" disabled={isLoading}>
                    {isLoading ? (
                ...
                <div className="space-y-3">
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        <span>
                          <strong className="text-foreground">Password Reset Link:</strong> Click the link in the email to reset your password
                        </span>
                      </li>
                      <li className="flex items-center gap-2">
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                    <p className="text-sm text-muted-foreground">
                      <strong className="text-foreground">Note:</strong> If you don't see the email, please check your spam folder. The link will expire in
                      1 hour.
                    </p>
                  </div>
                </div>
        ...
        <div className="text-center mt-8 md:mt-10 space-y-2">
          <p className="text-muted-foreground text-sm">
            ...
            <Button variant="link" asChild className="text-[var(--accent-text)] hover:text-[var(--accent-primary-hover)] p-0 ml-1 h-auto">
              <Link to="/system/login">Sign in</Link>
            </Button>
          </p>
          <p className="text-muted-foreground text-xs">© 2024 WebOnOne. All rights reserved.</p>
        </div>
