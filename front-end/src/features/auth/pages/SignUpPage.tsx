            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={password.length >= 6 ? "text-green-600 dark:text-green-400" : ""}>At least 6 characters</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check
                    className={`w-3 h-3 ${password === confirmPassword && password.length > 0 ? "text-green-500" : "text-gray-400"}`}
                  />
