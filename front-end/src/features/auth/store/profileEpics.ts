...
import { profileService } from '@/features/auth/services/profile';
...
// Load profile epic
export const loadProfileEpic = (action$: Observable<AnyAction>, state$: Observable<any>) =>
  action$.pipe(
...
// Update profile epic
export const updateProfileEpic = (action$: Observable<AnyAction>, state$: Observable<any>) =>
  action$.pipe(
...
// Delete profile epic
export const deleteProfileEpic = (action$: Observable<AnyAction>, state$: Observable<any>) =>
  action$.pipe(
...
// Upload avatar epic
export const uploadAvatarEpic = (action$: Observable<AnyAction>, state$: Observable<any>) =>
  action$.pipe(
...
export const changePasswordEpic = (action$: Observable<AnyAction>, state$: Observable<any>) =>
  action$.pipe(
