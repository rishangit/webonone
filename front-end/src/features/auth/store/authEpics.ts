...
// Sign-up epic
export const signUpEpic: Epic<any, any, any> = (action$) =>
  action$.pipe(
...
// Login epic
export const loginEpic: Epic<any, any, any> = (action$) =>
  action$.pipe(
...
export const completeLoginWithRoleEpic: Epic<any, any, any> = (action$) =>
  action$.pipe(
...
export const refreshUserEpic: Epic<any, any, any> = (action$) =>
  action$.pipe(
...
// Logout epic
export const logoutEpic: Epic<any, any, any> = (action$) =>
  action$.pipe(
    ofType(logout.type),
    tap(() => {
      // Clear localStorage
