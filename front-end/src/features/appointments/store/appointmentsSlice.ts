...
import { Appointment, CreateAppointmentData, UpdateAppointmentData } from '@/features/appointments/services/appointments';
import { AppointmentStatusType } from '@/features/appointments/types';
...
const appointmentsSlice = createSlice({
  ...
  reducers: {
    // Fetch appointments
    fetchAppointmentsRequest: (state, _action: PayloadAction<{ companyId?: string; filters?: any }>) => {
      state.loading = true;
      state.error = null;
    },
    ...
    fetchAppointmentRequest: (state, _action: PayloadAction<string>) => {
      state.loading = true;
      state.error = null;
    },
    ...
    // Create appointment
    createAppointmentRequest: (state, _action: PayloadAction<CreateAppointmentData>) => {
      state.loading = true;
      state.error = null;
    },
    ...
    // Update appointment
    updateAppointmentRequest: (state, _action: PayloadAction<{ id: string; data: UpdateAppointmentData }>) => {
      state.loading = true;
      state.error = null;
    },
    ...
    // Delete appointment
    deleteAppointmentRequest: (state, _action: PayloadAction<string>) => {
      state.loading = true;
      state.error = null;
    },
    ...
    updateAppointmentStatusRequest: (state, _action: PayloadAction<{ 
      id: string; 
