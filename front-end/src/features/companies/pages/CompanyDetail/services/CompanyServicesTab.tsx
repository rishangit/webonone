...
import type { Service as ServiceType } from "@/shared/types/services-catalog";
...
import {
  ...
  getImageUrl,
  getStatusColor,
} from "@/shared/utils/services-catalog-display";
    ...
    const fetchCompanyCurrency = async () => {
      ...
      try {
        ...
        if (!company || String(company.id) !== String(companyId)) {
          try {
            const { companiesService } = await import("@/features/companies/services");
