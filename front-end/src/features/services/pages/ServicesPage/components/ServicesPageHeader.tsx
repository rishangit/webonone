...
export function ServicesPageHeader({ isSuperAdmin, onAddCompanyService, onAddSystemService, id, headerActionsId }: ServicesPageHeaderProps) {
  return (
    <div id={id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
      <div>
      ...
      <div id={headerActionsId} className="flex flex-wrap items-center gap-2">
