    ...
    >
      <div className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="sales-date-range" className="text-sm font-medium text-foreground">Date Range</Label>
          <Select value={dateRange} onValueChange={onDateRangeChange}>
            <SelectTrigger id="sales-date-range" className="w-full bg-[var(--glass-bg)] border-[var(--glass-border)] text-foreground">
              <SelectValue />
            </SelectTrigger>
