...
import { TagsFiltersProps } from "@/features/tags/types";
...
}: TagsFiltersProps & { viewMode: "grid" | "list"; onViewModeChange: (mode: "grid" | "list") => void; isFilterPanelOpen: boolean; onFilterPanelOpenChange: (open: boolean) => void }) => {
  const hasActiveFilters = debouncedSearchTerm || filterStatus !== "active";
