...
import { fetchTagsRequest, createTagRequest } from "@/features/tags/store";
  ...
  useEffect(() => {
    if (pendingTagName && tags.length > 0) {
      const newTag = tags.find(
        (tag) => tag.name.toLowerCase() === pendingTagName.toLowerCase() && !value.includes(tag.id)
      );
                  ...
                  <div className="p-1 border-b border-border">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground">Add as new tag</div>
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    {filteredTags.map((tag) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {selected && <Check className="w-4 h-4 text-accent-foreground flex-shrink-0" />}
                        </div>
                      );
                    })}
                  </div>
