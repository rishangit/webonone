...
export const EditStockDialog = ({
  ...
  return (
    <CustomDialog
      ...
      description={`Update stock entry information for ${variantName}.`}
    ...
    >
      <form id="edit-stock-form" onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
        <StockFormFields
          register={register}
          control={control}
          errors={errors}
